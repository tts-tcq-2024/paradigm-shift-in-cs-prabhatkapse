...
namespace paradigm_shift_csharp
{
    class Checker
    {
        static bool valueRangeCheck(float minValue, float maxValue, float value)
        {
        ...
        static bool batteryIsOk(float minTemp, float maxTemp, float temp, float minSoc, float maxSoc, float soc, float maxChargeRate, float chargeRate)
        {
